...
export function Timer(props: Props) {
  ...
  return (
    <div className="h-16 bg-transparent grid place-items-center">
      <div className="w-full bg-color-2 rounded-full animate-fade">
        {secondsRemaining > 0 ? (
          <div
          ...
          <div className="flex justify-center">
            <p className="font-mono font-black text-center text-2xl text-red-500 animate-fade">
              Time&apos;s up!
            </p>
          </div>
        )}
